...
export function ProfileContact() {
  ...
  return (
    <Card className="bg-zinc-900/70 dark:bg-zinc-900/70 border-zinc-800 dark:border-zinc-800 backdrop-blur-sm">
      <CardContent className="p-4 sm:p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-zinc-800 dark:text-white">Email</h4>
              <a
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-zinc-800 dark:text-white">Phone</h4>
              <a
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-zinc-800 dark:text-white">Location</h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">{personalInfo.location}</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-medium text-zinc-800 dark:text-white">Working Hours</h4>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">{personalInfo.workingHours}</p>
            </div>
          </div>
        </div>
      </CardContent>
