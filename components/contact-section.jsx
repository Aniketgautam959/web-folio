...
export function ContactSection() {
  return (
    <Card className="bg-zinc-100/70 dark:bg-zinc-900/70 border-zinc-300 dark:border-zinc-800 backdrop-blur-sm col-span-1 md:col-span-3 lg:col-span-4 overflow-hidden">
      <CardContent className="p-0">
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="bg-zinc-200/50 dark:bg-zinc-800/50 p-6 lg:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                ...
                <SocialLinks socialLinks={[]} /> {/* Placeholder for social links */}
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 p-6 lg:p-8 max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-800/50">
            <h3 className="text-lg font-medium mb-6 text-black dark:text-white">Send a Message</h3>
            <ContactForm />
          </div>
        </div>
      </CardContent>
